...
#wget https://github.com/XTLS/Xray-core/releases/download/v1.8.6/Xray-linux-$v2ray_arch.zip
...
wget -O /usr/local/share/v2raya/LoyalsoldierSite.dat https://github.com/Loyalsoldier/v2ray-rules-dat/releases/latest/download/geosite.dat
wget -O /usr/local/share/v2raya/LoyalsoldierIP.dat https://github.com/Loyalsoldier/v2ray-rules-dat/releases/latest/download/geoip.dat
...
cd "$current_dir" || exit
rm -rf build
apk add --no-cache iptables iptables-legacy ip6tables nftables tzdata
